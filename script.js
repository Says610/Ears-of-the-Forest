...
function playEndingCutscene(type) {
    ...
    // Example: after 3 seconds, show secret ending text
    setTimeout(() => {
        const text = document.createElement("div");
        text.innerText = "You survived the forest… for now.";
...
function animateFull() {
    ...
    if (cutsceneActive) {
        // update cutscene animation (camera moves, fades)
